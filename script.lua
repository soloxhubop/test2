    ...
    local function startWalkFling()
        ...
        task.spawn(function()
            while _wfActive do
                ...
                local vel = root.AssemblyLinearVelocity
                pcall(function() root.AssemblyLinearVelocity = vel*10000 + Vector3.new(0,10000,0) end)
                RunService.RenderStepped:Wait()
                if root and root.Parent then pcall(function() root.AssemblyLinearVelocity = vel end) end
                RunService.Stepped:Wait()
                if root and root.Parent then pcall(function() root.AssemblyLinearVelocity = vel + Vector3.new(0,0.1,0) end) end
            end
        end)
    end
